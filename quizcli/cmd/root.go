...
// 	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.quizapi.yaml)")
...
// 		// Search config in home directory with name ".quizapi" (without extension).
// 		viper.AddConfigPath(home)
// 		viper.SetConfigName(".quizapi")
// 	}
...
func init() {
	conn, err := grpc.Dial(":1000", grpc.WithInsecure())
	if err != nil {
